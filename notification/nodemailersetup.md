...
now click on  oauth consent screen and fill in the required information (application name, support email, etc.). Make sure to add the necessary scopes for Gmail access.
...
3. **Create OAuth2 Credentials:**
   ...
   - After creating, you'll get your **ClientID** and **ClientSecret** use it in your `.env` file.
...
3. **Select Scopes:**
   - In Step 1 on the left panel, select the appropriate scopes for your application. For Gmail, choose:
    ...
    AFTER THIS IT WILL SHOW UNAUTHORISED
    YOU NEED TO GO TO THE console.cloud.google.com ,then click on project then go to oauth consent screen and click on audience 
